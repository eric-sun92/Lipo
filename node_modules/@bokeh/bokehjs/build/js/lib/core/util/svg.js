...
class CanvasGradient {
    static __name__ = "CanvasGradient";
    __root;
    __ctx;
...
export class SVGRenderingContext2D {
    static __name__ = "SVGRenderingContext2D";
    __canvas;
    __ctx;
    __root;
    __ids;
    ...
    lineWidth;
    globalAlpha = 1.0;
    globalCompositeOperation; // TODO: implement
    font;
    direction; // TODO: implement
    shadowColor;
    shadowOffsetX;
    shadowOffsetY;
    shadowBlur;
    ...
    imageSmoothingEnabled; // TODO: implement
    imageSmoothingQuality; // TODO: implement
    _width;
    _height;
    get width() {
        return this._width;
